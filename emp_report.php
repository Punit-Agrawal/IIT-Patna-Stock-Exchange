<h1 style='text-align:center'>Stock Distribution Report - Employee </h1>
...
<?php	
		...
		//	var_dump($sql);
			...
			$sql3="SELECT * FROM employee_allocation_report where item_id like '%Laptop%'";
		//	var_dump($sql);
			$list_of_items3=mysqli_query($conn, $sql3);
			$items3=mysqli_num_rows($list_of_items3);	

			$sql4="SELECT * FROM employee_allocation_report where item_id like '%Desktop%'";
		//	var_dump($sql);
		...
		//	var_dump($sql6);
			...
			$sql="SELECT * FROM employee_allocation_report order by issue_date desc";
		//	var_dump($sql);
...
<table style='text-align: start;'>
	<tr>
				...
				<td style='width:200px;'><?php echo "Total no. of Laptops issued to employees: ".$items3; ?></td>
				<td style='width:200px;'><?php echo "Total no. of Desktops issued to employees: ".$items4; ?></td>
			...
			<table style='text-align: center;'>
				...
				<th style='width:200px;border:1px solid;'>Emp Id</th>
