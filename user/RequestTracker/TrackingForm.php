...
<html>
	...
	<body>
		<script>
			function expand(row_num,total){
				if(document.getElementById("adv_row_"+row_num).style.display==''){
					...
					document.getElementById("exp1_"+row_num).innerHTML='+';
				}
				else{
					for(i=1;i<=total;i++){
						document.getElementById("adv_row_"+i).style.display='none';
						document.getElementById("exp1_"+i).innerHTML='+';
					}
		...
		<script>
			function edit(row_num,total){
				if(document.getElementById("adv_row_ed"+row_num).style.display==''){
					document.getElementById("adv_row_ed"+row_num).style.display='none';
					document.getElementById("exp_"+row_num).innerHTML='+';
				}
				else{
					for(i=1;i<=total;i++){
						document.getElementById("adv_row_ed"+i).style.display='none';
						document.getElementById("exp_"+i).innerHTML='+';
					}
					document.getElementById("adv_row_ed"+row_num).style.display='';
					document.getElementById("exp_"+row_num).innerHTML='-';
				}
			}
		</script>
